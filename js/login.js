...
const validateInput = (expression, input, campo) => {
  if (expression.test(input.value)) {
    ...
    document
      .querySelector(`#${campo}Container .helpMessage`)
      .classList.remove('helpMessage-active');
    campos[campo] = true;
    document
      .getElementById('alertMessage')
      .classList.remove('alertMessage-active');
  } else {
    ...
    document
      .querySelector(`#${campo}Container .helpMessage`)
      .classList.add('helpMessage-active');
    campos[campo] = false;
  }
};
...
document.getElementById('form').addEventListener('submit', function (e) {
  ...
  if (campos.email && campos.password) {
    ...
    document
      .getElementById('alertMessage')
      .classList.add('alertMessage-active');
  }
});
